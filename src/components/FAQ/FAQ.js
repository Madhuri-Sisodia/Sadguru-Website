  ...
  const FAQ=(props)=> {    
    ...
    return (    
      <div className='section faq-div'>
        ...
        <p className='darktext' style={{"color":"white","marginLeft":"1em"}}>You still have questions about the Public Sale or Tokenomics? Drop us a line on Telegram: https://t.me/wesenditcom</p>    
      </div>
    )
  }
  export default FAQ;
